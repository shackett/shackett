...
{ % include bio-section.html content="
This represents the latest human consensus model as of September 2025, but the model continues advancing (hopefully toward a 10-source 🦑 model soon!). To access the most current version, simply install the latest Napistu release and remove the version tag from `gcs.downloads.load_public_napistu_asset`.
" %}
