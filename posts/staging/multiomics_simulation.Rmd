...
net_connections <- igraph::sample_pa(n_species, power = 1, m = 2)
...
For systems that are just impacted by activation and inhibition (i.e., ignorning substrate <-> product interconversion), such an expression will look like:
