...
graph TB
    ...
    style DT fill:#ffeab3,stroke:#c27803,stroke-width:2px,color:#333
    style O fill:#b3f0c0,stroke:#2d8659,stroke-width:2px,color:#333
    style T fill:#b3d9f2,stroke:#2e7ba6,stroke-width:2px,color:#333
    style M fill:#b3d9f2,stroke:#2e7ba6,stroke-width:2px,color:#333
    style D fill:#b3d9f2,stroke:#2e7ba6,stroke-width:2px,color:#333
    style TR fill:#b3d9f2,stroke:#2e7ba6,stroke-width:2px,color:#333
...
graph LR
    ...
    C --> D[Node Embeddings]
    D --> E[Head<br/>Dot Product/MLP/Bilinear]
    E --> F[Predictions]
    ...
    style A fill:#ffeab3,stroke:#c27803,stroke-width:2px,color:#333
    style C fill:#b3d9f2,stroke:#2e7ba6,stroke-width:2px,color:#333
    style D fill:#b3d9f2,stroke:#2e7ba6,stroke-width:2px,color:#333
    style E fill:#b3d9f2,stroke:#2e7ba6,stroke-width:2px,color:#333
    style F fill:#b3f0c0,stroke:#2d8659,stroke-width:2px,color:#333
    style G fill:#ffeab3,stroke:#c27803,stroke-width:2px,color:#333
    style B fill:#b3d9f2,stroke:#2e7ba6,stroke-width:2px,color:#333,stroke-dasharray:5 5
    style H fill:#ffeab3,stroke:#c27803,stroke-width:2px,color:#333,stroke-dasharray:5 5
