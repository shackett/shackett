...
agreement_df = pd.DataFrame(agreement_data, index=["Spearman ρ"]).T
...
row_labels = ["(-)", "(+)"]
col_labels = ["(-)", "(+)"]
x_label = "PerturbSeq Prediction"
y_label = "Top Scoring Relation-Type"
title = "Activation vs. inhibition\nedge prediction agree with\nPerturbSeq ground-truth" + "\n" + f"log10p = {predicted_relation_type_vs_perturbseq_truth_pvalues[head].round(2)}"
