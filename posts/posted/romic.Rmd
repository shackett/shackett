...
```{r gasch_pcs, height = 8, width = 8}
samples_with_PCs <- triple_omic %>%
...
Based on this analysis we can see that most experiments cluster together aside from the "YPD" timecourses. These represent starvation conditions where the yeast clearly react with added measures beyond the ESR.
...
```{r static_heatmap, fig.height = 10, fig.width = 10}
plot_heatmap(
